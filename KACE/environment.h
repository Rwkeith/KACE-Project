...
namespace Environment
{
	...
	SYSTEM_PROCESS_INFORMATION*		   FilterProcesses(SYSTEM_PROCESS_INFORMATION* ProcessList,
													   ...
													   std::vector<int>);
	RTL_PROCESS_MODULES*			   FilterProcessModules(RTL_PROCESS_MODULES*	  proc_mod_list,
	...
	PRTL_PROCESS_MODULE_INFORMATION_EX FilterSystemModules(PRTL_PROCESS_MODULE_INFORMATION_EX module_list,
														   std::vector<std::string>&		  filter_list,
														   bool								  use_as_whitelist);
