...
// Our emulation is simulating the struct of Windows 10 | 2016 2110 21H2 (November 2021 Update) x64 - Make sure you use
// ntoskrnl.exe of that version
...
typedef enum _SYSTEM_INFORMATION_CLASS
{
	...
	SystemProcessorPerformanceInformation,	// q: SYSTEM_PROCESSOR_PERFORMANCE_INFORMATION (EX in: USHORT
											// ProcessorGroup)
	...
	SystemProcessorBrandString,	 // q: CHAR[] // HaliQuerySystemInformation -> HalpGetProcessorBrandString, info class
								 // 23
	...
	SystemLogicalProcessorAndGroupInformation,	// q: SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX (EX in:
												// LOGICAL_PROCESSOR_RELATIONSHIP RelationshipType) // since WIN7 //
